    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i <= 3; i++) {
            ...
            if (userInput == randomNumber) {
                ...
                if (i < 3) {
                    if (userInput > randomNumber) {
                        System.out.println(Colors.RED + "Too big, " + Colors.BOLD + (3 - i) + Colors.RESET + Colors.RED
                                + " tries left" + Colors.RESET);
                    } else {
                        System.out.println(Colors.RED + "Too small, " + Colors.BOLD + (3 - i) + Colors.RESET + Colors.RED
                                + " tries left" + Colors.RESET);
                    }
                } else {
